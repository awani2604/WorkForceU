...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-[#141821] flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight text-[#141821]">
                Find verified hands for <span className="text-orange-600">every job.</span>
              </h1>

              <p className="text-base sm:text-lg text-slate-500 max-w-2xl leading-relaxed">
                WorkForce India connects verified skilled tradespeople, apprentices, and businesses. Powered by the <strong className="text-[#141821]">Digital Skill Passport</strong>, transparent NSQF level certification, and instant crew booking.
              </p>

              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Link to="/role-select">
                  <Button variant="rust" size="lg" className="text-base font-semibold bg-orange-600 hover:bg-orange-700 border-orange-600">
                    Join WorkForce
                ...
                <Link to="/customer/search">
                  <Button variant="outline" size="lg" className="bg-white text-[#141821] border-slate-300 text-base">
                    Search Workers
                  </Button>
                </Link>

                <Link to="/customer/team-builder">
                  <Button variant="outline" size="lg" className="bg-white text-orange-700 border-orange-300 text-base">
                    Build a Crew
                  </Button>
                </Link>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-orange-100 text-xs text-slate-500">
                <div>
                  <strong className="block text-xl font-bold text-[#141821]">14,000+</strong>
                  <span>Verified Workers</span>
                </div>
                <div>
                  <strong className="block text-xl font-bold text-[#141821]">Level 0–6</strong>
                  <span>Skills Ladder</span>
                </div>
                <div>
                  <strong className="block text-xl font-bold text-[#141821]">100% Escrow</strong>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white text-[#141821] rounded-lg border-2 border-orange-100 shadow-xl overflow-hidden">
                <div className="bg-orange-600 text-white px-4 py-2.5 flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs font-bold">
                    <span className="w-2 h-2 rounded-full bg-white" />
                    WorkForce Digital Passport Preview
                  </div>
                  <span className="text-[10px] font-mono text-orange-100">WF-W-101</span>
                </div>
                ...
                <div className="p-5 space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <h4 className="text-base font-bold text-[#141821]">{sampleWorker.name}</h4>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="p-2.5 bg-orange-50 rounded border border-orange-100 text-center">
                      <span className="text-slate-500 block text-[10px]">Apprenticeship</span>
                      <strong className="text-orange-700 font-bold text-sm">320 Hours Logged</strong>
                    </div>
                    <div className="p-2.5 bg-orange-50 rounded border border-orange-100 text-center">
                      <span className="text-slate-500 block text-[10px]">Completed Jobs</span>
                  ...
                  <Link to={`/customer/worker/${sampleWorker.id}`} className="block">
                    <Button variant="rust" size="sm" className="w-full text-xs bg-orange-600 hover:bg-orange-700 border-orange-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg border border-orange-200 shadow-sm">
              ...
              <h3 className="text-base font-bold text-[#141821] mb-2">The WorkForce Solution</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
      ...
      <section id="how-it-works" className="py-14 sm:py-16 bg-white border-b border-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-xs font-bold uppercase tracking-wider text-orange-600">
            ...
            <p className="text-2xl sm:text-3xl font-extrabold text-[#141821] mt-1">
              How WorkForce India transforms informal labor into certified professionals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-lg border border-orange-100 bg-orange-50/40 flex flex-col justify-between">
              <div>
                ...
                <span className="text-xs font-bold text-orange-700 bg-orange-100 px-2 py-0.5 rounded uppercase">Step 1</span>
            ...
            <div className="p-6 rounded-lg border border-orange-100 bg-orange-50/40 flex flex-col justify-between">
              <div>
                ...
                <span className="text-xs font-bold text-orange-700 bg-orange-100 px-2 py-0.5 rounded uppercase">Step 2</span>
            ...
            <div className="p-6 rounded-lg border border-orange-200 bg-orange-50/60 flex flex-col justify-between">
              <div>
                ...
                <span className="text-xs font-bold text-orange-700 bg-orange-100 px-2 py-0.5 rounded uppercase">Step 3</span>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-lg border border-orange-100 shadow-sm">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
              <div className="p-3 bg-orange-50 rounded border border-orange-100">
                ...
                <span className="text-slate-500 mt-1 block">Digital modules, basic safety guidelines, tool orientation.</span>
              </div>
              <div className="p-3 bg-orange-50 rounded border border-orange-100">
                <span className="font-bold text-orange-700 block">Level 2: Assistant</span>
                <span className="text-slate-500 mt-1 block">Verified 300 hrs on-site apprenticeship with a licensed mentor.</span>
              </div>
              <div className="p-3 bg-orange-50 rounded border border-orange-100">
                <span className="font-bold text-orange-700 block">Levels 3 & 4: Skilled & Senior</span>
                <span className="text-slate-500 mt-1 block">Independent task execution, specialized residential & commercial mastery.</span>
              </div>
              <div className="p-3 bg-orange-50 rounded border border-orange-100">
                <span className="font-bold text-orange-700 block">Levels 5 & 6: Supervisor & Contractor</span>
                <span className="text-slate-500 mt-1 block">Crew leadership, blueprint compliance, multi-trade project delivery.</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="categories" className="py-14 sm:py-16 bg-white border-b border-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-6 space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#141821] leading-tight">
                ...
                <span className="text-orange-600">Deploy with the Team Builder.</span>
              </h2>
              ...
              <div className="pt-2">
                <Link to="/customer/team-builder">
                  <Button variant="rust" size="md" className="bg-orange-600 hover:bg-orange-700 border-orange-600">
            ...
            <div className="lg:col-span-6">
              <div className="bg-white rounded-lg border border-orange-100 shadow-sm p-5 space-y-3 text-xs">
                <div className="flex items-center justify-between pb-3 border-b border-orange-100">
                  <span className="font-bold text-[#141821] text-sm">Example: House Construction Crew</span>
                  <span className="bg-orange-600 text-white px-2 py-0.5 rounded font-semibold text-[10px]">10 WORKERS</span>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between items-center bg-orange-50 p-2.5 rounded border border-orange-100">
                    <span className="text-[#141821]">1 Project Contractor (Level 6)</span>
                    <span className="font-mono text-slate-500">₹2,500/day</span>
                  </div>
                  <div className="flex justify-between items-center bg-orange-50 p-2.5 rounded border border-orange-100">
                    <span className="text-[#141821]">2 Lead Masons (Supervisor Level 5)</span>
                    <span className="font-mono text-slate-500">₹2,800/day</span>
                  </div>
                  <div className="flex justify-between items-center bg-orange-50 p-2.5 rounded border border-orange-100">
                    <span className="text-[#141821]">5 General Labourers (Level 1)</span>
                    <span className="font-mono text-slate-500">₹2,500/day</span>
                  </div>
                  <div className="flex justify-between items-center bg-orange-50 p-2.5 rounded border border-orange-100">
                    <span className="text-[#141821]">1 Conduit Electrician + 1 Plumber</span>
                    <span className="font-mono text-slate-500">₹1,700/day</span>
                  </div>
                </div>
      ...
      {/* Footer — shared component, white + orange theme, giant wordmark */}
      <Footer />
    </div>
  );
};
